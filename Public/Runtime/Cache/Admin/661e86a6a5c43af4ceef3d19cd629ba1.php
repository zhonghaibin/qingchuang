...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 报告管理 <span class="c-gray en">&gt;</span> 申请帮助报告 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<form method="get" action="/index.php/Admin/Report/rewards.html?search_status=1&amp;search_starttime=&amp;search_endtime=&amp;search_username=&amp;token=1b2cbd9fbed93dd16ee148001cd0a463_522522a0626868947c57e4bd6eabc777">
<div class="pd-20">
  <div class="text-c"> 
	...
	<label><input name="search_status" value="3"  type="radio"  <?php if($arr["search_status"] == 3): ?>checked <?php elseif($_GET['search_status']== 3): ?>checked<?php endif; ?> >打款完成</label>
	&nbsp;&nbsp;&nbsp;
  ...
  <table class="table table-border table-bordered table-hover table-bg table-sort">
	...
	<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="text-c">
        ...
        <?php if($arr["search_status"] == 1): ?><td class="user-status"> <a title="撤单" href="javascript:;" onClick="r_del(this,<?php echo ($vo["id"]); ?>)" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe66b;</i>   撤单</a></td><?php endif; ?>
