...
<body>
<div class="pd-20">
  <form class="Huiform" action="/index.php/Admin/Member/userpasswordedit.html?id=453" method="post">
    <table class="table">
      <tbody>
        <tr>
		...
		<tr>
          <th></th>
          <td><button class="btn btn-success radius" onclick='user_password_save(<?php echo ($id); ?>)' type="button"><i class="icon-ok"></i> 确定</button></td>
        </tr>
