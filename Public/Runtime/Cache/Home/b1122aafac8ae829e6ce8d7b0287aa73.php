    ...
    <div class="divcentent">
        <div class="new_dv">
			...
			<div class="head_title" >
             <span class=" path left" >新闻</span>
            </div>
            <ul class="new_list">
			<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><a class="new_title" href="<?php echo U('Home/Article/newspage/',array('id'=>$vo['id']));?>"><?php echo ($vo["art_title"]); ?></a><span class="new_date"><?php echo (date('Y-m-d H:i:s',$vo["art_time"])); ?></span></li><?php endforeach; endif; else: echo "" ;endif; ?>
            </ul>
         <div class="page">
			<?php echo ($page); ?>  
        </div>
