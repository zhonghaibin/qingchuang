 ...
 <div class="MessBox" >
    <div class="divcentent">
		...
		<div class="head_title" >
		 <span class=" path left" >信件 > 回复</span>
         </div> 
		  <div style='padding:10px 50px;'>
		  <div  style='font-size:16px;;margin: 5px 0px;'>主题：<?php echo ($relust["subject"]); ?></div>
		  <div  style='font-size:16px;;margin: 5px 0px;'>时间：<?php echo (date('Y-m-d H:i:s',$relust["addtime"])); ?></div>
		  <div  style='font-size:16px;margin: 5px 0px;'>内容：<?php echo ($relust["content"]); ?></div>
		  <div  style='font-size:16px;margin: 5px 0px;'>回复：<?php if($relust["reply"] != "" ): echo ($relust["reply"]); else: ?>暂时还未回复<?php endif; ?></div>
		  </div>
        </div>
    </div>
</div>
