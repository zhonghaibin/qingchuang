  ...
  <div class="MessBox" >
    <div class="divcentent">
		...
		<div class="head_title" >
             <span class=" path left" >交易记录 > 接收帮助记录</span>
            </div>
            <div style="margin:20px;">
            <table class="tablebg">
                        <tbody>
                            <tr class="datafield">
                                <th style="border: 1px #fceed1 solid; font-size: 12px;" colspan="6">
                                    <nobr>接收帮助记录</nobr>
                                </th>
							...
							<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="datalist">
								...
								<tr class="datalist heddin_<?php echo ($vo["id"]); ?> heddin">
                                 <td style="border: 1px #fceed1 solid; font-size: 12px;" colspan='9'>
									...
									<?php if(is_array($listcr)): $i = 0; $__LIST__ = $listcr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vos): $mod = ($i % 2 );++$i; if($vos["r_id"] == $vo["id"]): ?><tr class="datalist">
										   ...
										   <strong id="second_show_<?php echo ($i); ?>" style="color:#d00000;"><s></s>00s</strong><?php endif; ?>
											...
											<td> <a href='javascript:#' ' onclick='receivables("600","600","接收帮助","<?php echo U("Transaction/receivables",array("id"=>$vos["id"]));?>")'>详情</a></td>
										</tr>
